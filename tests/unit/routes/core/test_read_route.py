"""Test the 'synse_server.routes.core' Synse Server module's read route."""
...
from synse_server.routes.core import read_route
...
def mock_read(monkeypatch):
    ...
    mock = asynctest.CoroutineMock(synse_server.commands.read, side_effect=mockreturn)
