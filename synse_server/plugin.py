...
class Plugin:
    ...
    Args:
        info (dict): A dictionary containing the metadata and version
            info for the associated plugin.
    ...
    def __init__(self, info, client):
        ...
        self.sdk_version = info.get('sdk_version')
        self.maintainer = info.get('maintainer')
        self.version = info.get('version')
        self.name = info.get('name')
        self.vcs = info.get('vcs')
