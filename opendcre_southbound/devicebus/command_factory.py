#!/usr/bin/env python
""" A Factory to make new Commands for OpenDCRE.

This factory is largely used for convenience and organization. All Command objects
built for OpenDCRE should be built through this factory.
...
class CommandFactory(object):
    """ Factory for building the supported OpenDCRE Commands.
    """
