...
class Max11608Thermistor(I2CDevice):
    ...
    def _read(self, command):
        ...
        try:
            ...
            raise OpenDCREException('Error reading temperature sensor (device id {})'.format(device_id)), None, sys.exc_info()[2]
            ...
            if self.hardware_type == 'emulator':
                ...
                try:
                    ...
                    if vec.GetAck() == ACK:
                        ...
                        if vec.GetAck() != ACK:
                            raise OpenDCREException('I2C Bus Error: No ACK received after setup/configuration write.')
