#!/usr/bin/env python
""" OpenDCRE Southbound Entity MIB entitySensor entPhySensorTable.
...
class EntityPhysicalSensorTable(SnmpTable):
    ...
    def _get_device_type(sensor_type):
        ...
        :returns: The corresponding OpenDCRE device type."""

        # TODO: Localization for strings.

        # Other and unknown are not device types supported by OpenDCRE.
    ...
    def get_scan_device_public(self, sensor_type):
        ...
        :returns: Device information for a scan if the device type is supported
         or can be supported in OpenDCRE, else None."""
