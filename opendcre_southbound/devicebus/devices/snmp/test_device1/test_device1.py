...
""" OpenDCRE Southbound SNMP testDevice1 Implementation.
    ...
    the another device would not support.
...
from opendcre_southbound import constants
...
class TestDevice1(SnmpServerBase):
    """ Device bus Interface for SNMP commands to the OpenDCRE-testDevice1 SNMP Server.
    This is a specific SNMP device/server interface for the OpenDCRE-testDevice1 Server.
    """
    ...
    def _fan(self, command):
        ...
        if table_name != 'OpenDcre-TestDevice1-Fan-Table':
    ...
    def _led(self, command):
        """OpenDCRE API power command implementation for the TestDevice1 SNMP server.
        Args:
        ...
        if table_name != 'OpenDcre-TestDevice1-Led-Table':
    ...
    def _read(self, command):
        """OpenDCRE API read command implementation for the TestDevice1 SNMP server.
        ...
        elif table_name == 'OpenDcre-TestDevice1-Power-Table':
    ...
    def _read_test_device1(self, scan_results, snmp_server, rack_id):
        ...
        device_config. Example 'snmp-emulator-opendcre-testdevice1-board2'.
