#!/usr/bin/env python
""" VaporCORE Southbound API Endpoint Utils and Helpers test case
...
from opendcre_southbound.devicebus.devices import PLCDevice, IPMIDevice, RedfishDevice
...
class EndpointUtilitiesTestCase(unittest.TestCase):
    ...
    def test_001_register_plc(self):
        ...
        # define the mock app config and override the southbound app
