...
RACK_1 = 'rack_1'
RACK_2 = 'rack_2'
SNMP_EMULATOR_TEST = 'snmp-emulator-test'
...
class SnmpDeviceRegistrationTestCase(OpenDcreHttpTest):
    ...
    def test_scan_all_force(self):
        ...
        # we have two racks defined in the config, but one rack contains an invalid
    ...
    def test_version_rack2(self):
        ...
        response = http.get(Uri.create(_S.URI_VERSION, RACK_2, BOARD_60000000)).json()
