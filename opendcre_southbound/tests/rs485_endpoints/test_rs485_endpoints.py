#!/usr/bin/env python
""" OpenDCRE Southbound RS485 Endpoint Tests
...
class Rs485EndpointsTestCase(unittest.TestCase):
    """ RS485 Endpoint tests test hitting OpenDCRE endpoints with only RS485
    ...
    def test_014_read_humidity_version(self):
        ...
        self.assertIsInstance(response, dict)
        self.assertEqual(
            'OpenDCRE RS-485 Bridge v1.0', response['firmware_version'])
