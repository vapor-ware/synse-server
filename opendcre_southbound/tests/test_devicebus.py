#!/usr/bin/env python
"""
OpenDCRE Southbound Devicebus Tests
Author:  erick
Date:    10/20/2015
    \\//
     \/apor IO
...
from devicebus import DeviceBusPacket, BusDataException, board_id_to_bytes, board_id_join_bytes, \
    device_id_to_bytes, device_id_join_bytes


class DevicebusTestCase(unittest.TestCase):
    """
        Test the Vapor OpenDCRE devicebus
    """
    ...
    def test_006_instantiate_valid_devicebus_packet_method_C(self):
        ...
        """
        # TODO - implement the test for a serial reader
        pass
