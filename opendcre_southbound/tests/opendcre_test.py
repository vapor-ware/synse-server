...
class OpenDcreHttpTest(unittest.TestCase):
    ...
    def _get_rack_by_id(self, response, rack_id):
        ...
        :param response: The http response from OpenDCRE.
    ...
    def _verify_led_response(self, response, led_state, led_color, blink_state):
        ...
        :param response: The raw LED response from OpenDCRE.
    ...
    def _verify_power_response(
        ...
        :param response: The raw power response from OpenDCRE.
    ...
    def _verify_read_fan_response(self, response, health, states, speed_rpm):
        ...
        :param response: The raw read response from OpenDCRE.
    ...
    def _verify_vapor_http_error(self, e, http_code, message):
        ...
        :param e: The VaporHTTPError from OpenDCRE.
        :param http_code: The expected http_code.
        :param message: The message from OpenDCRE."""
    ...
    def _verify_version_snmp(self, response, version):
        ...
        :param response: The raw version response from OpenDCRE.
