...
class HTTPUntrustedTestCase(unittest.TestCase):
    ...
    def test_000_http(self):
        ...
        """
        self.assertFalse(http._trust_enabled)

    def test_001_http(self):
        """ Test http get with mocked in responses giving back a
        "good" response. Since trust is not enabled, there should be
    ...
    def test_002_http(self):
        """ Test http get with mocked in responses giving back a
        "good" response with headers. Since trust is not enabled, there
