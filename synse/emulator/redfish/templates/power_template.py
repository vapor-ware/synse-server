...
POWER_TEMPLATE = {
    ...
    'PowerControl': [
        {
            '@odata.id': '/redfish/v1/Chassis/{ob_id}/PowerMetrics#/PowerControl/0',
            'MemberId': '0',
    ...
    'Voltages': [
        {
            '@odata.id': '/redfish/v1/Chassis/{ob_id}/PowerMetrics#/Voltages/0',
            'MemberId': '0',
            'Name': 'VRM1 Voltage',
            'SensorNumber': 11,
            'Status': {
        ...
        {
            '@odata.id': '/redfish/v1/Chassis/{ob_id}/PowerMetrics#/Voltages/1',
            'MemberId': '1',
            'Name': 'VRM2 Voltage',
            'SensorNumber': 12,
            'Status': {
    ...
    'PowerSupplies': [
        {
            '@odata.id': '/redfish/v1/Chassis/{ob_id}/Power#/PowerSupplies/0',
            'MemberId': '0',
        ...
        {
            '@odata.id': '/redfish/v1/Chassis/{ob_id}/Power#/PowerSupplies/1',
            'MemberId': '1',
        ...
        {
            '@odata.id': '/redfish/v1/Chassis/{ob_id}/Power#/PowerSupplies/2',
            'MemberId': '2',
